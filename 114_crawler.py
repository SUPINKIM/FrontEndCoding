# -*- coding: utf-8 -*-
"""
Created on Tue Dec  3 10:31:00 2019
...
driver.get('https://play.google.com/store/apps/details?id=kt.smart&hl=ko')
...
while scroll_down:
    ...
    try:
        more = driver.find_element_by_class_name('RveJvd snByac') #더보기 버튼이 나오면 클릭
...
f=open('C:/Users/paprikastory/.spyder-py3/cokcok_114.txt','w',encoding='utf-8')
